...
<==================>
27
2 3 3 2 1 6 5 2 6 5 8 4 3 4 2 2 4 5 3 1 4 7 2 2 2 7 5 
<==================>
...
make run < Inputs/08.in > Solutions/08.out  1843.22s user 3.06s system 743% cpu 4:08.48 total
```
...
1. We first flood (seed) all cells that are surrounded with 3 or 4 walls.
